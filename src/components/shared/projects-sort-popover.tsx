...
export function ProjectsSortPopover() {
  const { sortCriteria, sortDirection, setSortCriteria, setSortDirection } =
    useProjectsStore();
    ...
    <Popover>
      ...
      <PopoverContent className="w-56 p-4">
        <div className="space-y-4">
          <h3 className="font-medium text-sm">Sort Projects</h3>
            ...
            >
              ...
              <div className="flex items-center space-x-2">
                <RadioGroupItem
                  ...
                  id="sort-title"
                />
                <Label htmlFor="sort-title" className="text-sm font-normal">
                  Title
                </Label>
              </div>
            </RadioGroup>
